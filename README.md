...
* Make sure the robot is in a valid position before starting. An example for a pose (without the blue box, gripper on the ground, you can find [here](https://github.com/a-laborie/Group10-CS470-fall2022/blob/main/maxredefault.jpg) 
